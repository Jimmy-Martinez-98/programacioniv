      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown"> 
          <div class="dropdown ml-auto ">
              <a class="btn btn-lg  dropdown-toggle" href="#" @click="slidedropdown" role="button" id="dropdownMenuLink" data-toggle="dropdown" data-hover="dropdown" aria-haspopup="true" aria-expanded="false">
                {{perfil[0].nombreu}}
              </a>
...
<div class="container-fluid " id="contenedorP"style="margin-top: 150px;"></div>
