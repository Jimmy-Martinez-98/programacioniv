  ...
  appbandeja = new Vue({
    ...
    methods: {
      ...
      traerusuario: function () {
        fetch(
          `../../../Private/Modulos/usuarios/procesos.php?proceso=traercuenta&login=""`
        )
          .then((resp) => resp.json())
          .then((resp) => {
      ...
      vermensajes: function () {
        fetch(
          `../../../Private/Modulos/usuarios/procesos.php?proceso=traerusuarios&login=""`
        )
          .then((resp) => resp.json())
          .then((resp) => {
            this.users = resp;
...
socket.on("recibirMensaje", (msg) => {
  if (
    (msg.de === appbandeja.msg.de && msg.para === appbandeja.msg.para) ||
    ...
    if (msg.de != appbandeja.msg.de) {
      $.notification(
        "Agro Producers Tienes Un Mensaje",
        msg.msg,
        "../../img/logo2,0.png"
      );
    }
