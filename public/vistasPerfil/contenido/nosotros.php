...
<body>
	...
	<form action="#" method="post" id="frm-nosotros" >
			...
			<div class="col-12 text-white">
				...
				<p v-for="nosotros in about" >{{nosotros.Vision}}</p>
			</div>
			</div>
			<div class="col-12 text-white">
				<div class="form-group">
		...
		<div class="card-foote-fluid pb-2">
			<div class="container ">
				<div class="row">
				  ...
				  <div class="col-12">
					<button type="button" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#modalinformacion">
...
<!-- Modal -->
<div class="modal fade"  id="modalinformacion" tabindex="-1" role="dialog" aria-labelledby="modalinformacionTitle" aria-hidden="true">
	<link rel="stylesheet" href="public/vistasPerfil/contenido/nosotros.css">
